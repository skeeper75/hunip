...
```bash
bash ${CLAUDE_SKILL_DIR}/scripts/verify-design-tokens.sh
```
...
정적 디자인 토큰: `${CLAUDE_SKILL_DIR}/data/design-tokens.json`

추출 스크립트: `${CLAUDE_SKILL_DIR}/scripts/extract-design-tokens.ts` (FIGMA_ACCESS_TOKEN 필요)

상품 섹션 분석: `${CLAUDE_SKILL_DIR}/product-sections/01~11-*.md`
