...
- IA Feature Mapping: `${CLAUDE_SKILL_DIR}/../../references/feature-mapping.md`
...
**기능**: [Feature name from IA]
**분류**: [NATIVE | SKIN | CUSTOM | EXTERNAL]

**shopby 네이티브 지원**:
- [What's available out-of-the-box]
- 관리자 경로: [shopby admin menu path]
- API: [relevant API endpoint]

**커스텀 개발 필요**:
- [What needs to be built]
- 추천 접근방식: [architecture suggestion]
...
**추천 정책안**: [Concrete recommendation based on analysis]
```
